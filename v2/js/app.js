...
/***/ "./resources/js/v2/ImageMarker.js":
/*!****************************************!*\
  !*** ./resources/js/v2/ImageMarker.js ***!
  \****************************************/
/***/ (() => {
...
(function ($) {
  ...
  var scaling = {
    ...
    event: function event(elem) {
      ...
      $(elem).find('.content').addClass('animated'); // Wrapper selector
      ...
      $(this.settings.selector).each(function () {
        ...
        $('.toggle', this).on('click', function (e) {
          e.preventDefault();
          $(this).closest(scaling.settings.selector).toggleClass('active'); // Selector Click
          ...
          if ($(this).closest(scaling.settings.selector).hasClass('active') && !$(this).closest(scaling.settings.selector).hasClass('disabled')) {
            ...
            id.addClass('content__visible'); // id.fadeIn();
        ...
        idTarget.find('.exit').on('click', function (e) {
          e.preventDefault(); // selector.removeClass('active');

          $('[data-popover="' + target + '"]').removeClass('active'); // idTarget.removeClass(scaling.settings.animationPopoverIn);
          // idTarget.addClass(scaling.settings.animationPopoverOut);
          // idTarget.delay(500).fadeOut();

          idTarget.removeClass('content__visible');
        });
      });
    },
    //----------------------------------------//
    // Layout
    //----------------------------------------//
    layout: function layout(elem) {
      // Get Original Image
      var image = new Image();
      image.src = elem.find('.target').attr("src"); // Variable

      var width = image.naturalWidth,
          height = image.naturalHeight,
          getWidthLess = $(elem).width(),
          setPersenWidth = getWidthLess / width * 100,
          setHeight = height * setPersenWidth / 100; // Set Heigh Element

      $(elem).css("height", setHeight); // Resize Width
      ...
      $(this.settings.selector).each(function () {
        ...
        $(this).css("left", getLeft + "px"); // Target Position
...
/* harmony import */ var _ImageMarker__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ImageMarker */ "./resources/js/v2/ImageMarker.js");
/* harmony import */ var _ImageMarker__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_ImageMarker__WEBPACK_IMPORTED_MODULE_3__);
...
(function (jq, Splide) {
  if (jq('.slider__hero').length) {
    new Splide('.slider__hero', {
      type: 'loop',
      height: 320,
      arrows: false,
      breakpoints: {
  ...
  if (jq('.slider__popover').length) {
    new Splide('.slider__popover', {
      arrows: false
    }).mount();
  } // ============================================================


  if (jq('.slider__categories--desktop').length) {
    new Splide('.slider__categories--desktop', {
      pagination: false,
      perPage: 12,
      gap: 20,
      drag: 'free',
  ...
  if (jq('.slider__categories--mobile').length) {
    new Swiper(".slider__categories--mobile", {
      spaceBetween: 24,
      freeMode: true,
      scrollbar: {
        el: ".swiper-scrollbar"
  ...
  if (jq('.slider__products').length) {
    var __products = document.getElementsByClassName('slider__products');

    for (var i = 0; i < __products.length; i++) {
      new Splide(__products[i], {
        pagination: false,
        perPage: 5,
        gap: 20,
        padding: 20,
  ...
  if (jq('.slider__banner').length) {
    var __banners = document.getElementsByClassName('slider__banner');

    for (var i = 0; i < __banners.length; i++) {
      new Splide(__banners[i], {
        type: 'loop',
        height: 240
      }).mount();
    }
  ...
  var navbar = jq('.navbar__wrapper');
  var navProduct = jq('.nav-product');
  var scrolled = (0,rxjs__WEBPACK_IMPORTED_MODULE_0__.fromEvent)(document, 'scroll').pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_1__.debounceTime)(0)).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(function () {
    return window.scrollY;
  }));
  scrolled.subscribe(function (y) {
    if (y > 0) {
    ...
    if (navProduct.length) {
      if (y > 400) {
        navProduct.addClass('nav-product--visible');
      } else {
        navProduct.removeClass('nav-product--visible');
      }
    }
  }); // ============================================================

  var productsPriceRange = document.querySelector('.products-price-range');

  if (document.body.contains(productsPriceRange)) {
    noUiSlider.create(productsPriceRange, {
      start: [3],
      range: {
        'min': [0],
        'max': [5]
  ...
  if (jq('.product__slider-thumbs').length) {
    var thumbnails = new Splide(".product__slider-thumbs", {
      width: 80,
      height: 500,
      gap: 10,
      direction: "ttb",
  ...
  if (jq('.quick-view__slider').length) {
    var main = new Splide('.quick-view__slider', {
      type: 'fade',
      height: 400,
      rewind: true,
      pagination: false,
  ...
  if (jq('.quick-view__slider-thumbs').length) {
    var _thumbnails = new Splide(".quick-view__slider-thumbs", {
      width: 80,
      height: 400,
      gap: 10,
      direction: "ttb",
...
/******/ 	__webpack_require__.O(undefined, ["v2/css/app"], () => (__webpack_require__("./resources/js/v2/app.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["v2/css/app"], () => (__webpack_require__("./resources/sass/v2/app.scss")))
